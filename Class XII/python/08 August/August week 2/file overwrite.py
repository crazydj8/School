...
if os.path.exists("D:\\Study\\School\\Class XII\\08 August\\August week 2\\files\\source.txt"):
    f1 = open("D:\\Study\\School\\Class XII\\08 August\\August week 2\\files\\source.txt", "r")
    if os.path.exists("D:\\Study\\School\\Class XII\\08 August\\August week 2\\files\\destination.txt"):
        a = input("Do you want to overwrite the file?(yes/no)")
        if a == "yes":
            f2 = open("D:\\Study\\School\\Class XII\\08 August\\August week 2\\files\\destination.txt", "w")
            str = f1.read()
            f2.write(str)
