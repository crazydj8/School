...
import os                   #made by Akshat Aryan

def add():                  #made by Akshat Aryan
    global txt
    txt = ""
...
def search(x):                  #made by Akshat Aryan
    size = os.path.getsize(file)
    if size == 0:
        print("File Empty")
    else:
...
def delete(x):                  #made by Akshat Aryan
    size = os.path.getsize(file)
    if size == 0:
        print("File Empty")
    else:
...
def modify(x, a, b):                    #made by Akshat Aryan
    size = os.path.getsize(file)
    if size == 0:
        print("File Empty")
    else:
...
file = "D:\\Study\\School\\Online classes Python\\08 August\\August week 2\\files\\projectDFH.txt"                 #made by Akshat Aryan
txt = ""
f1 = open(file, "a+")                   #made by Akshat Aryan

while True:                 #made by Akshat Aryan
    print("Your choices are: \n1. Add \n2. Edit \n3. Search \n4. Delete \n5. Print \n6. Exit")
    x = int(input("Enter option number:"))
    if x == 1:                  #made by Akshat Aryan
        while True:
            add()
    ...
    elif x == 2:                    #made by Akshat Aryan
        a = int(input("Enter the Roll No. you have to modify:"))
        b = input("Enter new name:")
        c = input("Enter new percentage:")
        modify(a, b, c)
    
    elif x == 3:                    #made by Akshat Aryan
        a = int(input("Enter the Roll No. you have to search for:"))
        search(a)
        
    elif x == 4:                    #made by Akshat Aryan
        a = int(input("Enter the Roll No. you have to delete:"))
        delete(a)
        
    elif x == 5:                    #made by Akshat Aryan
        prt()
    
    elif x == 6:                    #made by Akshat Aryan
        break

f1.close()                  #made by Akshat Aryan
#Copyright- CrazyDj8 Copyright- CrazyDj8 Copyright- CrazyDj8 Copyright- CrazyDj8 Copyright- CrazyDj8