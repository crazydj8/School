#Quiz Project v4.0 (MySQL integrated)

import tkinter as tk
import webbrowser
import loginfunc, signupfunc, feedbackfunc, editfunc, quizfunc, finishfunc, analysisfunc, leaderfunc, catfunc
from tkinter import font as tkfont
from tkinter import ttk

#Main Window
window = tk.Tk()
window.title("Quiz v4.0")
...
#Comboboox style create
combostyle = ttk.Style()
combostyle.theme_create("combostyle1",
                        parent = "alt",
                        settings = {"TCombobox" :
                                        {"configure" :
...
credit_title = tk.Label(master = credit,
    ...
    width = 26,
    font = heading)
credit_title.grid(row = 0, column = 0, columnspan = 2, pady= (25, 10), sticky = "w")
...
creator = tk.Label(master = credit,
    ...
    text = "Akshat\nAbdullah\nAbhay\nAditya Sharma",
    font = text)
creator.grid(row = 1, column = 1, rowspan = 2, padx = (10, 0), pady = (0,15), sticky = "w")
...
beta = tk.Label(master = credit,
    ...
    text = "Abdullah\nAbhay\nAditya Sharma",
    font = text)
beta.grid(row = 3, column = 1, rowspan = 2, padx = (10, 0), pady = (0, 15), sticky = "w")
...
back_btn.grid(row = 9, column = 1, padx = (50, 0), pady = (15, 0), sticky = "w")
...
login_btn = tk.Button(master = login,
    ...
    text = "Login",
    font = btntext,
    command = lambda: [loginfunc.login(userent, passent, loginerror, edit, feedback), catfunc.combobox(category_box, combostyle, cstyle1),
    R1.select(), editfunc.showques(queslbl, anslbl, choice, c1), nques_ent.focus_set(), loginfunc.reset(userent, passent, loginerror)])
...
back_btn = tk.Button(master = login,
    ...
    text = "Go Back",
    font = btntext,
    command = lambda: [loginfunc.goback(userent, passent, loginerror, intro, feedback)])
...
#Category Label
cat_lbl = tk.Label(master = edit,
    bg = "black",
    fg = "lime",
    text = "Select Category:",
    font = text)
cat_lbl.grid(row = 1, column = 0, columnspan = 2, pady = (12), sticky = "ew")
#ComboBox representing the category
c1 = tk.StringVar()

category_box = ttk.Combobox(master = edit,
    width = 15,
    textvariable = c1,
    font = text)
category_box.grid(row = 1, column = 2, columnspan = 2, padx = (10,0), ipady = (1), sticky = "w")
category_box["state"] = "readonly"

#Apply button to apply changes
apply_btn=tk.Button(master = edit,
    bg = "lime",
    fg = "black",
    width = 10,
    activeforeground = "lime",
    ...
    text = "Apply",
    font = btntext,
    command = lambda: [R1.select(), editfunc.showques(queslbl, anslbl, choice, c1), editfunc.errorreset(qerror)])
apply_btn.grid(row = 1, column = 4, padx = (10,0), sticky = "w")
...
R1 = tk.Radiobutton(master = edit,
    ...
    value = 1,
    font = btntext,
    command = lambda: [editfunc.showques(queslbl, anslbl, choice, c1), editfunc.errorreset(qerror)])
...
queslbl = tk.Label(master = edit,
    ...
    text = "Question",
    font = text)
queslbl.grid(row = 3, column = 0, columnspan = 5, pady = (20, 5))
...
anslbl = tk.Label(master = edit,
    ...
    text = "Answer",
    font = text)
anslbl.grid(row = 4, column = 0, columnspan = 5, pady = (5, 10))
...
nqueslbl = tk.Label(master = edit,
    ...
    text = "New Question:",
    font = text)
nqueslbl.grid(row = 5, column = 0, columnspan = 2, padx = (0, 10), pady = (10, 5), sticky = "e")
...
nques_ent = tk.Entry(master = edit,
    ...
    insertbackground = "lime",
    font = text)
nques_ent.grid(row = 5, column = 2, columnspan = 3, padx = (10, 0), pady = (10, 5), sticky = "w")
...
nanslbl = tk.Label(master = edit,
    ...
    text = "New Answer:",
    font = text)
nanslbl.grid(row = 6, column = 0, columnspan = 2, padx = (0, 10), pady = (5, 25), sticky = "e")
...
nans_ent = tk.Entry(master = edit,
    ...
    insertbackground = "lime",
    font = text)
nans_ent.grid(row = 6, column = 2, columnspan = 3, padx = (10, 0), pady = (5, 25), sticky = "w")
...
qerror = tk.Label(master = edit,
    ...
    text = "",
    font = text)
qerror.grid(row = 7, column = 0, columnspan = 5, pady = (0, 10))
...
edit_btn = tk.Button(master = edit,
    ...
    text = "Edit",
    font = btntext,
    command = lambda: [editfunc.changeques(choice, nques_ent, nans_ent, qerror, c1), editfunc.showques(queslbl, anslbl, choice, c1),
    editfunc.reset(nques_ent, nans_ent)])
edit_btn.grid(row = 8, column = 3, columnspan = 2, pady = (25, 300), sticky = "w")
...
home_btn.grid(row = 8, column = 0, columnspan = 2, pady = (25, 300), sticky = "e")
...
#User centre button
usercentre_btn = tk.Button(master = player,
    bg = "lime",
    fg = "black",
    width = 21,
    activeforeground = "lime",
    ...
    text = "User Centre",
    font = btntext,
    command = lambda: centre.tkraise())
usercentre_btn.grid(row = 3, column = 0, pady = (0, 50))
...
play_btn = tk.Button(master = player,
    ...
    text = "Play Quiz!",
    font = btntext,
    command = lambda: [quiz.tkraise(), playername_ent.focus_set(), catfunc.combobox(cat_box, combostyle, cstyle1)])
...
lb_btn = tk.Button(master = player,
    ...
    text = "View Highscore",
    font = btntext,
    command = lambda: [leaderfunc.lbreset(name1, name2, name3, name4, name5, name6, name7, name8, name9, name10, score1, score2,
    score3, score4, score5, score6, score7, score8, score9, score10), leaderfunc.main(name1, name2, name3, name4, name5, name6,
    name7, name8, name9, name10, score1, score2, score3, score4, score5, score6, score7, score8, score9, score10), leaderboard.tkraise()])
...
#Category Label
category_lbl = tk.Label(master = quiz,
    bg = "black",
    fg = "lime",
    text = "Select Category:",
    font = text)
category_lbl.grid(row = 1, column = 0, padx = (0, 10), pady = (12), sticky = "e")

#ComboBox representing the category
cat = tk.StringVar()
cat_box = ttk.Combobox(master = quiz,
    width = 18,
    textvariable = cat,
    font = text)
cat_box.grid(row = 1, column = 1, padx = (10, 0), ipady = (1), sticky = "w")
...
playername_lbl = tk.Label(master = quiz,
    ...
    font = text)
playername_lbl.grid(row = 2, column = 0, padx = (0, 10), pady = (13), sticky = "e")
...
playername_ent = tk.Entry(master = quiz,
    ...
    insertbackground = "lime",
    font = text)
playername_ent.grid(row = 2, column = 1, padx = (10, 0), pady = (13), sticky = "w")
...
playerror = tk.Label(master = quiz,
    ...
    text = "",
    font = text)
playerror.grid(row = 3, column = 0, columnspan = 2, pady = (0, 50))
...
start_btn = tk.Button(master = quiz,
    ...
    text = "Start Quiz",
    font = btntext,
    command = lambda: [quizfunc.setvar([second1, second2, second3, second4, second5]), quizfunc.savename(playername_ent, playerror),
    quizfunc.play(playername_ent, q1, playerror, q1_lbl, q2_lbl, q3_lbl, q4_lbl, q5_lbl, cat), quizfunc.reset(playername_ent, playerror,
    tim1_lbl), a1_ent.focus_set(), quizfunc.time1(second1, tim1_lbl, a1_ent, q1error, window)])
start_btn.grid(row = 4, column = 1, padx = (60, 0), pady = (25, 550), sticky = "w")
...
back_btn1.grid(row = 4, column = 0, padx = (0, 50), pady = (25, 550), sticky = "e")

# # # # # # # # # # # # # # # # User Centre Frame # # # # # # # # # # # # # # # # # # # #
centre = tk.Frame(master = god,
    bg = "black")
centre.grid(row = 0, column = 0, sticky = "nsew")

#Title - User Centre
manage_title = tk.Label(master = centre,
    bg = "black",
    fg = "lime",
    text = "User Centre",
    width = 26,
...
signup_btn = tk.Button(master = centre,
    bg = "lime",
    fg = "black",
    width = 21,
    activeforeground = "lime",
...
#Remove admin button
feedback_btn = tk.Button(master = centre,
    bg = "lime",
    fg = "black",
    width = 21,
    activeforeground = "lime",
    ...
    text = "Feedback",
    font = btntext,
    command = lambda: [feedback.tkraise(), fbackname.focus_set()])
feedback_btn.grid(row = 2, column = 0, pady = (0, 50))

#Back button
back_btn = tk.Button(master = centre,
    bg = "lime",
    fg = "black",
    width = 21,
    activeforeground = "lime",
...
back_btn2 = tk.Button(master = signup,
    ...
    text = "Go Back",
    font = btntext,
    command = lambda: [signupfunc.back(user_ent, password_ent, cpassent, signuperror), centre.tkraise()])
back_btn2.grid(row = 5, column = 0, padx = (0, 55), pady = (25, 400), sticky = "e")

# # # # # # # # # # # # # # # # Feedback Frame # # # # # # # # # # # # # # # # # # # #
feedback = tk.Frame(master = god,
    bg = "black")
feedback.grid(row = 0, column = 0, sticky = "nsew")

#Title - Feedback
fbacktitle = tk.Label(master = feedback,
    bg = "black",
    fg = "lime",
    text = "Feedback",
    width = 26,
    font = heading)
fbacktitle.grid(row = 0, column = 0, columnspan = 2, pady = (75, 50), sticky = "w")

#Name Label
fbackuser = tk.Label(master = feedback,
    bg = "black",
    fg = "lime",
    text = "Enter your name:",
    font = text)
fbackuser.grid(row = 1, column = 0, padx = (0, 10), pady = (0, 20), sticky = 'e')

#Name Entry
fbackname = tk.Entry(master = feedback,
    bg = "black",
    fg = "lime",
    highlightbackground = "lime",
    highlightcolor = "lime",
    ...
    width = 21,
    font = text)
fbackname.grid(row = 1, column = 1, padx = (10, 0), pady = (0, 20), sticky = "w")

#Feedback Label
fbacklbl = tk.Label(master = feedback,
    bg = "black",
    fg = "lime",
    text = "Enter Feedback:",
    font = text)
fbacklbl.grid(row = 2, column = 0, padx = (0, 10), sticky = "ne")

#Feedback Entry
fbackent = tk.Text(master = feedback,
    bg = "black",
    fg = "lime",
    highlightbackground = "lime",
    highlightcolor = "lime",
    ...
    wrap = tk.WORD,
    font = text)
fbackent.grid(row = 2, column = 1, rowspan = 2, padx = (10, 0), sticky = "nw")

#Error which occurs if any
fbackerror = tk.Label(master = feedback,
    bg = "black",
    fg = "red",
    text = "",
    font = text)
fbackerror.grid(row = 4, column = 0, columnspan = 2, pady = (25, 0))

#Remove button
removebtn = tk.Button(master = feedback,
    bg = "lime",
    fg = "black",
    width = 13,
    activeforeground = "lime",
    ...
    text = "Submit",
    font = btntext,
    command = lambda: [feedbackfunc.submit(fbackname, fbackent, fbackerror, removebtn)])
removebtn.grid(row = 5, column = 1, padx = (100, 0), pady = (50, 0), sticky = "w")

#Home button
homebtn = tk.Button(master = feedback,
    bg = "lime",
    fg = "black",
    width = 13,
    activeforeground = "lime",
    ...
    text = "Home",
    font = btntext,
    command = lambda: [feedbackfunc.home(fbackname, fbackent, fbackerror, removebtn), intro.tkraise()])
homebtn.grid(row = 5, column = 0, padx = (0, 50), pady = (50, 0), sticky = "e")
...
tim1_lbl = tk.Label(master = q1,
    bg = "black",
    fg = "lime",
    text = "Time left: " + second1.get(),
    font = btntext)
tim1_lbl.grid(row = 0, column = 1, padx = 20, pady = 25, sticky = "e")
...
q1_title = tk.Label(master = q1,
    ...
    text = "Question 1",
    font = heading)
q1_title.grid(row = 1, column = 0, columnspan = 2, pady = (0, 50))
...
q1_lbl = tk.Label(master = q1,
    ...
    width = 50,
    font = text)
q1_lbl.grid(row = 2, column = 0, columnspan = 2, pady = (25), sticky = "w")
...
a1_lbl = tk.Label(master = q1,
    ...
    text = "Answer :",
    font = text)
a1_lbl.grid(row = 3, column = 0, padx = (0, 10), pady = (25), sticky ="e")
...
a1_ent = tk.Entry(master = q1,
    ...
    insertbackground = "lime",
    font = text)
a1_ent.grid(row = 3, column = 1, padx = (10, 0), pady = (25), sticky = "w")
...
q1error = tk.Label(master = q1,
    ...
    text = "",
    font = text)
q1error.grid(row = 4, column = 0, columnspan = 2, pady = (0, 35))
...
nextbtn = tk.Button(master = q1,
    ...
    text = "Next",
    font = btntext,
    command = lambda: [quizfunc.answer(q1_title, a1_ent, q1error), quizfunc.take(a1_ent, q1error),
    quizfunc.reset(a1_ent, q1error, tim1_lbl), a2_ent.focus_set(), quizfunc.nextframe(a1_ent, q1error, q2), quizfunc.time1(second2,
    tim2_lbl, a2_ent, q2error, window), quizfunc.destroy(a1_ent, q1error)])
nextbtn.grid(row = 5, column = 1, pady = (25, 400))
...
#Timer
second2 = tk.StringVar()
tim2_lbl = tk.Label(master = q2,
    bg = "black",
    fg = "lime",
    text = "Time left: " + second1.get(),
    font = btntext)
tim2_lbl.grid(row = 0, column = 1, padx = 20, pady = 25, sticky = "e")
...
q2_title = tk.Label(master = q2,
    ...
    text = "Question 2",
    font = heading)
q2_title.grid(row = 1, column = 0, columnspan = 2, pady = (0, 50))
...
q2_lbl = tk.Label(master = q2,
    ...
    width = 50,
    font = text)
q2_lbl.grid(row = 2, column = 0, columnspan = 2, pady = (25), sticky = "w")
...
a2_lbl = tk.Label(master = q2,
    ...
    text = "Answer :",
    font = text)
a2_lbl.grid(row = 3, column = 0, padx = (0, 10), pady = (25), sticky = "e")
...
a2_ent = tk.Entry(master = q2,
    ...
    insertbackground = "lime",
    font = text)
a2_ent.grid(row = 3, column = 1, padx = (10, 0), pady = (25), sticky = "w")
...
q2error = tk.Label(master = q2,
    ...
    text = "",
    font = text)
q2error.grid(row = 4, column = 0, columnspan = 2, pady = (0, 35))
...
nextbtn = tk.Button(master = q2,
    ...
    text = "Next",
    font = btntext,
    command = lambda: [quizfunc.answer(q2_title, a2_ent, q2error), quizfunc.take(a2_ent, q2error),
    quizfunc.reset(a2_ent, q2error, tim2_lbl), a3_ent.focus_set(), quizfunc.nextframe(a2_ent, q2error, q3), quizfunc.time1(second3,
    tim3_lbl, a3_ent, q3error, window), quizfunc.destroy(a2_ent, q2error)])
nextbtn.grid(row = 5, column = 1, pady = (25, 400))
...
#Timer
second3 = tk.StringVar()
tim3_lbl = tk.Label(master = q3,
    bg = "black",
    fg = "lime",
    text = "Time left: " + second1.get(),
    font = btntext)
tim3_lbl.grid(row = 0, column = 1, padx = 20, pady = 25, sticky = "e")
...
q3_title = tk.Label(master = q3,
    ...
    text = "Question 3",
    font = heading)
q3_title.grid(row = 1, column = 0, columnspan = 2, pady = (0, 50))
...
q3_lbl = tk.Label(master = q3,
    ...
    width = 50,
    font = text)
q3_lbl.grid(row = 2, column = 0, columnspan = 2, pady = (25), sticky = "w")
...
a3_lbl = tk.Label(master = q3,
    ...
    text = "Answer :",
    font = text)
a3_lbl.grid(row = 3, column = 0, padx = (0, 10), pady = (25), sticky = "e")
...
a3_ent = tk.Entry(master = q3,
    ...
    insertbackground = "lime",
    font = text)
a3_ent.grid(row = 3, column = 1, padx = (10, 0), pady = (25), sticky = "w")
...
q3error = tk.Label(master = q3,
    ...
    text = "",
    font = text)
q3error.grid(row = 4, column = 0, columnspan = 2, pady = (0, 35))
...
nextbtn = tk.Button(master = q3,
    ...
    text = "Next",
    font = btntext,
    command = lambda: [quizfunc.answer(q3_title, a3_ent, q3error), quizfunc.take(a3_ent, q3error),
    quizfunc.reset(a3_ent, q3error, tim3_lbl), a4_ent.focus_set(), quizfunc.nextframe(a3_ent, q3error, q4), quizfunc.time1(second4, 
    tim4_lbl, a4_ent, q4error, window), quizfunc.destroy(a3_ent, q3error)])
nextbtn.grid(row = 5, column = 1, pady = (25,   400))
...
#Timer
second4 = tk.StringVar()
tim4_lbl = tk.Label(master = q4,
    bg = "black",
    fg = "lime",
    text = "Time left: " + second1.get(),
    font = btntext)
tim4_lbl.grid(row = 0, column = 1, padx = 20, pady = 25, sticky = "e")
...
q4_title = tk.Label(master = q4,
    ...
    text = "Question 4",
    font = heading)
q4_title.grid(row = 1, column = 0, columnspan = 2, pady = (0, 50))
...
q4_lbl = tk.Label(master = q4,
    ...
    width = 50,
    font = text)
q4_lbl.grid(row = 2, column = 0, columnspan = 2, pady = (25))
...
a4_lbl = tk.Label(master = q4,
    ...
    text = "Answer :",
    font = text)
a4_lbl.grid(row = 3, column = 0, padx = (10, 0), pady = (25), sticky = "e")
...
a4_ent = tk.Entry(master = q4,
    ...
    insertbackground = "lime",
    font = text)
a4_ent.grid(row = 3, column = 1, padx = (10, 0), pady = (25), sticky = "w")
...
q4error = tk.Label(master = q4,
    ...
    text = "",
    font = text)
q4error.grid(row = 4, column = 0, columnspan = 2, pady = (0, 35))
...
nextbtn = tk.Button(master = q4,
    ...
    text = "Next",
    font = btntext,
    command = lambda: [quizfunc.answer(q4_title, a4_ent, q4error), quizfunc.take(a4_ent, q4error),
    quizfunc.reset(a4_ent, q4error, tim4_lbl), a5_ent.focus_set(), quizfunc.nextframe(a4_ent, q4error, q5), quizfunc.time1(second5, 
    tim5_lbl, a5_ent, q5error, window), quizfunc.destroy(a4_ent, q4error)])
nextbtn.grid(row = 5, column = 1, pady = (25,   400))
...
#Timer
second5 = tk.StringVar()
tim5_lbl = tk.Label(master = q5,
    bg = "black",
    fg = "lime",
    text = "Time left: " + second1.get(),
    font = btntext)
tim5_lbl.grid(row = 0, column = 1, padx = 20, pady = 25, sticky = "e")
...
q5_title = tk.Label(master = q5,
    ...
    text = "Question 5",
    font = heading)
q5_title.grid(row = 1, column = 0, columnspan = 2, pady = (0, 50))
...
q5_lbl = tk.Label(master = q5,
    ...
    width = 50,
    font = text)
q5_lbl.grid(row = 2, column = 0, columnspan = 2, pady = (25))
...
a5_lbl = tk.Label(master = q5,
    ...
    text = "Answer :",
    font = text)
a5_lbl.grid(row = 3, column = 0, padx = (0, 10), pady = (25), sticky = "e")
...
a5_ent = tk.Entry(master = q5,
    ...
    insertbackground = "lime",
    font = text)
a5_ent.grid(row = 3, column = 1, padx = (10, 0), pady = (25), sticky = "w")
...
q5error = tk.Label(master = q5,
    ...
    text = "",
    font = text)
q5error.grid(row = 4, column = 0, columnspan = 2, pady = (0, 50))
...
finishbtn = tk.Button(master = q5,
    ...
    text = "Finish",
    font = btntext,
    command = lambda: [quizfunc.answer(q5_title, a5_ent, q5error), quizfunc.scores(a5_ent, q5error), quizfunc.finish(name_lbl,
    score_lbl, a5_ent, q5error), quizfunc.take(a5_ent, q5error), quizfunc.analyseques(q1lbl, q2lbl, q3lbl, q4lbl, q5lbl), 
    quizfunc.analyse(yourans, yourans1, yourans2, yourans3, yourans4, cans, cans1, cans2, cans3, cans4), quizfunc.reset(a5_ent, 
    q5error, tim5_lbl), quizfunc.nextframe(a5_ent, q5error, finishscrn), quizfunc.destroy(a5_ent, q5error)])
finishbtn.grid(row = 5, column = 1, pady = (25, 400))
...
leaderboardbtn = tk.Button(master = finishscrn,
    ...
    text = "View Highscore",
    font = btntext,
    command = lambda: [leaderfunc.lbreset(name1, name2, name3, name4, name5, name6, name7, name8, name9, name10, score1, score2, score3,
    score4, score5, score6, score7, score8, score9, score10), leaderfunc.main(name1, name2, name3, name4, name5, name6, name7, name8, 
    name9, name10, score1, score2, score3, score4, score5, score6, score7, score8, score9, score10), finishfunc.reset(name_lbl, score_lbl), 
    leaderboard.tkraise()])
...
leaderboardbtn = tk.Button(master = analysis,
    ...
    command = lambda: [leaderfunc.lbreset(name1, name2, name3, name4, name5, name6, name7, name8, name9, name10, score1, score2, 
    score3, score4, score5, score6, score7, score8, score9, score10), leaderfunc.main(name1, name2, name3, name4, name5, name6, 
    name7, name8, name9, name10, score1, score2, score3, score4, score5, score6, score7, score8, score9, score10), 
    analysisfunc.reset(yourans, yourans1, yourans2, yourans3, yourans4, cans, cans1, cans2, cans3, cans4, q1lbl, q2lbl, q3lbl,
...
homebtn = tk.Button(master = analysis,
    ...
    text = "Home",
    font = btntext,
    command = lambda: [analysisfunc.reset(yourans, yourans1, yourans2, yourans3, yourans4, cans, cans1, cans2, cans3, cans4, 
    q1lbl, q2lbl, q3lbl, q4lbl, q5lbl), quizfunc.scorereset(), intro.tkraise()])
...
homebtn = tk.Button(master = leaderboard,
    ...
    font = btntext,
    command = lambda: [leaderfunc.lbreset(name1, name2, name3, name4, name5, name6, name7, name8, name9, name10, score1, score2,
    score3, score4, score5, score6, score7, score8, score9, score10), quizfunc.scorereset(), intro.tkraise()])
homebtn.grid(row = 3, column = 0, pady = (25, 0), padx = (0, 37), sticky  = "e")

delbtn = tk.Button(master = leaderboard,
    bg = "lime",
    fg = "black",
    width = 13,
    activeforeground = "lime",
    ...
    font = btntext,
    command = lambda: [leaderfunc.lbdel(), leaderfunc.lbreset(name1, name2, name3, name4, name5, name6, name7, name8, name9, 
    name10, score1, score2, score3, score4, score5, score6, score7, score8, score9, score10), leaderfunc.main(name1, name2, 
    name3, name4, name5, name6, name7, name8, name9, name10, score1, score2, score3, score4, score5, score6, score7, score8, 
    score9, score10)])
delbtn.grid(row = 3, column = 1, pady = (25, 0), padx = (37, 0), sticky = "w")
